  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../pages/dashboard.html">
        ...
        <span class="ms-1 font-weight-bold">Travel Agency Management</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../admin/packform.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../admin/billing.php">
            ...
            <span class="nav-link-text ms-1">Answer Query</span>
          </a>
        </li>
        <!-- <li class="nav-item">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link font-weight-bold px-0 text-body">
                ...
                <a class="d-sm-inline d-none" href="../index.html">Sign Out</a>
              </a>
            </li>
    ...
    <div class="container-fluid py-4">
          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" method="POST" action="createpack.php">
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "pname" placeholder="Package Name" aria-label="Name" aria-describedby="email-addon" required >
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control"  name= "ptype" placeholder="Package Type" aria-label="Name" aria-describedby="email-addon" required >
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control"  name= "description" placeholder="Description" aria-label="Name" aria-describedby="email-addon" >
                  </div>
                  
                  <div class="mb-3">
                    <input type="text" class="form-control"  name= "destination" placeholder="Destination" aria-label="Email" aria-describedby="email-addon" required >
                  </div>
                  
                  <!-- <input type="checkbox" name="formWheelchair" value="Yes" /> -->
                  <div class="mb-3">
                    <input type="number" class="form-control"  name= "price"  placeholder="Price" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  
                  <div class="mb-3">
                    <input type="text" class="form-control"  name= "tmode" placeholder="Transport Mode" aria-label="Email" aria-describedby="email-addon" required >
                  </div>
                  <div class="mb-3">
                    <input type="number" class="form-control"  name= "seats"  placeholder="Seats" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  <div class="mb-3">
                    <input type="number" class="form-control"  name= "prate" placeholder="Positivity Rate" aria-label="Password" aria-describedby="password-addon" required>
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control"  name= "vtype" placeholder="Vehicle Type" aria-label="Password" aria-describedby="password-addon" required>
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control"  name= "date" placeholder="DATE format yyyy-mm-dd" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" aria-label="Password" aria-describedby="password-addon">
                  </div>
                  ...
                  <!-- <div class="mb-3">
                    ...
                    <input type="text" class="form-control"  name= "del" placeholder="Pack ID" aria-label="Password" aria-describedby="password-addon">
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Delete</button>
                  </div> -->
                ...
                <div class="mb-3">
                    <label>Delete Package</label>
                    <input type="text" class="form-control"  name= "del" placeholder="Pack ID" aria-label="Password" aria-describedby="password-addon" required>
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Delete</button>
                  </div>
    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Travel Agency Management</h5>
