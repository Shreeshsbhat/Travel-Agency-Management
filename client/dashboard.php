      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../client/billing.php">
            ...
            <span class="nav-link-text ms-1">Ask Query</span>
          </a>
        </li>
        <!-- <li class="nav-item">
      ...
      <div class="row">
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            ...
            <form role="form text-left" method="POST" action="book.php">
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "phone" placeholder="Phone" aria-label="Name" aria-describedby="email-addon" pattern="[1-9]{1}[0-9]{9}">
                  </div>
                  
                  <div class="mb-3">
                    <input type="number" class="form-control" name= "id" placeholder="Pack ID" aria-label="Name" aria-describedby="email-addon">
                    <p>Refer to Pack ID on Right</p>
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Book</button>
                  </div>
        ...
        <!-- <div class="col-12 col-xl-4">
          ...
          <form role="form text-left" method="POST" action="#">
                  ...
                  <div class="mb-3">
                    <input type="number" class="form-control" name= "B_ID" placeholder="Booking ID" aria-label="Name" aria-describedby="email-addon">
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Book</button>
                  </div>
        ...
        <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Delete Booking</h6><br/><br/><br/>
            </div>
            <form role="form text-left" method="POST" action = "delete.php">
        ...
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            <h6>&nbsp package And Price</h6>
            <p>Sorted According to the Positivity Rate</p>
          <?php
                ...
                $ph=$row[0];
                $sql = "select Budget from client where Mobile='$ph'";
                $result = mysqli_query($conn,$sql);
                $row = mysqli_fetch_array($result, MYSQLI_NUM);
                $ph=$row[0];

                sel("select Destination,P_ID,Positivity_Rate,Price,Reservation_date from package where Price <= '$ph' order by Positivity_Rate ASC");
                ?> 
          </div>
        </div>
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              ...
              <p>Customer have to pay the full amount by any means available during  travelling</p>
              <p class="text-sm"></p>
            </div>
            <div class="card-body p-3">
              ...
              <?php
                ...
                $row = mysqli_fetch_array($result, MYSQLI_NUM);
                $ph=$row[0];
                $sql="select * from bookings where Mobile='$ph'";
                sel($sql);
                ?> 
            </div>
          </div>
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg ">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <p class="text-sm d-xl-none d-block mt-2">You can change the sie
        <div class="mt-3">
