  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../client/billing.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl shadow-none" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Query</h6>
        </nav>
  ...
  <div class="left-half">
    ...
    <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">ASK QUERY</h6>
            </div>
            <form role="form text-left" method="POST" action="ans.php">
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "sub" placeholder="Subject" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "ans" placeholder="Question" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Ask</button>
                  </div>
  ...
  <div class="right-half">
    ...
    <div class="card h-100">
            ...
            <?php
                ...
                $ph=$row[0];
                sel("select Distinct e.C_ID,Subject,Description,Reg_date from enquiry e,register r,client c where e.C_ID =r.C_ID and e.c_ID=c.C_ID and c.C_ID=r.C_ID and c.Mobile like '$ph' and Remark like '0' limit 5");
                ?> 
          </div>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body p-3">
              ...
              <?php
                ...
                $result = mysqli_query($conn,$sql);
                $row = mysqli_fetch_array($result, MYSQLI_NUM);
                sel("select * from enquiry where C_ID='$row[0]' and Remark not like '0'");
                ?> 
            </div>
          </div>
        </div>
