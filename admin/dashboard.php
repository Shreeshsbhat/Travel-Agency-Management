      ...
      <div class="row">
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              ...
              <p>Customer needs to be registered in order to book here</p>
            </div>
            <form role="form text-left" method="POST" action="book.php">
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "phone" placeholder="Phone" aria-label="Name" aria-describedby="email-addon" required pattern="[1-9]{1}[0-9]{9}">
                  </div>
        ...
        <div class="col-12 col-xl-4">
          ...
          <?php
                ...
                sel("select Destination,P_ID,Positivity_Rate,Price,Reservation_date from package ORDER BY Positivity_Rate ASC");
                ?> 
          </div>
        </div>
