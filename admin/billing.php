  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../admin/packform.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../admin/billing.php">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Queries</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Queries</h6>
        </nav>
  ...
  <div class="left-half">
    ...
    <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">ANSWER QUERY</h6>
            </div>
            <form role="form text-left" method="POST" action="ans.php">
                  <div class="mb-3">
                    <input type="number" class="form-control" name= "EID" placeholder="EID" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  <div class="mb-3">
                    <input type="number" class="form-control" name= "CID" placeholder="CID" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "ans" placeholder="ANSWER" aria-label="Name" aria-describedby="email-addon" required>
                  </div>
                  <div class="mb-3">
                    <input type="text" class="form-control" name= "date" placeholder="DATE format yyyy-mm-dd" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" aria-label="Name" aria-describedby="email-addon" >
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Answer</button>
                  </div>
  ...
  <div class="right-half">
    ...
    <div class="card h-100">
            ...
            <?php
                ...
                sel("select Distinct e.C_ID,Subject,Description,Reg_date from enquiry e,register r where r.C_ID =e.C_ID and Remark like '0' limit 5");
                ?> 
          </div>
        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            ...
            <div class="card-body p-3">
              ...
              <?php
                require_once 'select.php';
                // sel("select e.C_ID,e.Emp_ID,Subject,Reg_date,Answer_Date,Description,Remark from enquiry e,register r,answer a  where r.C_ID =e.C_ID and e.Emp_ID=a.Emp_ID and Remark not like '0'");
                sel("select Distinct * from enquiry where Remark not like '0'")
                ?> 
            </div>
          </div>
        </div>
